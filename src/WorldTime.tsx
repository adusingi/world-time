...
// The app. Big editable source time as a hero (type any time to schedule a
// meeting), target cities as a card grid, and a full-width emerald timeline.
export function WorldTime() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1c] px-4 py-10 text-slate-100">
